<script>
	...
	const examples = {
		...
		richtext_102: {
			...
			subtitle:
				'Listening to the on-transaction event instead of on-change, e.g. to track changes to the current selection. Useful to track the state of menu buttons.',
		...
		richtext_103: {
			...
			subtitle:
				'Serializing to and from JSON (and saving your state to local storage, just for fun).',
